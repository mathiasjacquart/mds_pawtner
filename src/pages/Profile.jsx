...
// --- Composant pour afficher le profil du chien ---
...
const FormProfil = ({ chien, onSave }) => {
  ...
  const handleActivitesChange = (e) => {
    ...
    setFormData({ ...formData, activites: val.split(",").map(a => a.trim()) });
  };
...
export default function App() {
  ...
  // useEffect : fonction qui s'exécute au premier rendu du composant
  useEffect(() => {
